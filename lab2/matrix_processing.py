...
def zero_search(matrix, n, m):
    try:
        l = int(input("Введите количество верхних строк в матрице, в которых будем искать нулевые элементы: "))
        k = int(input("Введите количество левых столбцов в матрице, в которых будем искать нулевые элементы: "))
